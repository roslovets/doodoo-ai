...
AS $$
DECLARE
  project_url TEXT := 'https://nenbbqbupuvrgiukmzic.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5lbmJicWJ1cHV2cmdpdWttemljIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxNDkzOTkxOCwiZXhwIjoyMDMwNTE1OTE4fQ.Ks_stdJWcxrVclc2O4vxV6YjFV-saTqDfzoLue_CejY'; -- full access needed for http request to storage
